...
$string['by'] = ' by ';
$string['checkallradiobuttons'] = 'Please check you have selected a response for each question';
...
$string['wrongformat'] = 'Please ensure you have responded to the following questions:&nbsp;';
$string['wrongformats'] = 'Please ensure you have responded to the following questions:&nbsp;';
$string['yesno'] = 'Yes/No';
$string['yesno_help'] = 'Simple Yes/No question.';

$string['psat_scoring'] = '<h3>Ranking</h3>
                            <p>0 = I am establishing a base level of experience / knowledge / not applicable at this stage or for this directorship</p>
                            <p>1 = I have started applying my knowledge and extending my experience</p>
                            <p>2 = I am experienced and am seeking greater depth</p>
                            <p>3 = I have advanced knowledge and experience and seek currency</p>';
?>